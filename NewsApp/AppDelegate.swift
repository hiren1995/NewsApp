...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate,MessagingDelegate {
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data)
    {
        ...
        if let refreshedToken = InstanceID.instanceID().token(){
            ...
            let dashboardViewController = story.instantiateViewController(withIdentifier: "dashboardViewController") as! DashboardViewController
            
            dashboardViewController.loadData()
            dashboardViewController.DashBoardTableView.reloadData()
